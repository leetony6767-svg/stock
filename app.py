...
st.markdown("""
    ...
    * {
    ...
    .stApp {
        background: linear-gradient(135deg, #f5f0eb 0%, #e8d9c9 100%);
    }
    ...
    .stButton > button {
        ...
        box-shadow: 0 6px 20px rgba(232,185,159,0.4) !important;
    }

    .stButton > button:hover {
        transform: translateY(-3px);
        box-shadow: 0 10px 25px rgba(232,185,159,0.6) !important;
    }

    .stTextInput > div > div > input {
        background: rgba(255,255,255,0.85) !important;
        color: #3f2a1e !important;
        border: 1px solid #e8b99f !important;
        border-radius: 16px !important;
    ...
    .success {
        background: rgba(100, 200, 150, 0.25) !important;
        color: #ffffff !important;
        padding: 18px;
        border-radius: 16px;
        margin: 16px 0;
