...
st.markdown("""
    ...
    * {
    ...
    .stApp {
        background: linear-gradient(135deg, #f8f1e9 0%, #e8d9c9 100%);
    }
    ...
    .stButton > button {
        background: linear-gradient(90deg, #d4af37, #f0d48a) !important;
    ...
    .stButton > button:hover {
        background: linear-gradient(90deg, #f0d48a, #d4af37) !important;
